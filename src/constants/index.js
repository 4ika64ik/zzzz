...
export const reviews = [
    {
        ...
        feedback: "Юлия - вдохновленный лидер, помогающий нашим клиентам сделать переезд в новую страну легким и комфортным. Её заботливый подход и богатый опыт в области международной адаптации обеспечивают нашим клиентам гладкое переездное период и быструю адаптацию к новым условиям жизни."
    },
    {
        imgURL: luba,
