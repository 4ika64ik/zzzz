  ...
  return (
    <section id='country' style={sectionStyle}>
      <div className='flex flex-col justify-start gap-5'>
        ...
        Представьте мир, где переезд за границу и получение ВНЖ не является сложным и утомительным процессом. <br></br><br></br>Где каждый ваш шаг к новой жизни в другой стране сопровождается командой профессионалов, которые знают все подводные камни и лучшие пути их обхода. Проект Юлии Навальной превращает эту мечту в реальность.
<br></br><br></br>
...
<p className='mt-2 font-montserrat text-slate-gray'>Иван Ургант, Олег Тиньков, Юрий Дудь и многие другие уже выразили свою поддержку и восхищение нашим сервисом. <br></br><br></br>Они были удивлены, насколько все быстро, легко и качественно. Но самое главное — они были поражены тем, что существует проект, который действительно ставит интересы и нужды людей на первое место.

<br></br><br></br>Использование нашего сервиса — это не просто шаг к переезду. Это шаг к новой жизни без стресса и лишних забот. Это возможность начать все с чистого листа в новой стране, имея за спиной поддержку настоящих профессионалов.
